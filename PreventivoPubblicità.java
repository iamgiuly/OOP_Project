 ...
 * @author Serena
 */
public class PreventivoPubblicità extends java.awt.Dialog {

    /**
     * Creates new form PreventivoPubblicità
     */
    public PreventivoPubblicità(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel6.setText("Tipo stampa");

        jLabel7.setText("Inchiostro");
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                PreventivoPubblicità dialog = new PreventivoPubblicità(new java.awt.Frame(), true);
