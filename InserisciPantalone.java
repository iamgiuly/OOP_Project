...
public class InserisciPantalone extends java.awt.Dialog {
    
    Magazzino mag=new Magazzino();
    int id=mag.getLastIDpanta();
    AtomicInteger a=new AtomicInteger(id);
    int s,m,l,xl;
    String gen,col,mod,mat;
    float pb;

    /**
     * Creates new form InserisciPantalone
     * @param parent
     * @param modal
     */
    public InserisciPantalone(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void button1MouseClicked(java.awt.event.MouseEvent evt) {                                     
        ...
        pb=Float.parseFloat(jTextField5.getText());
        mag.inserisciPantalone(a.incrementAndGet(), gen,col,mat,mod, s,m,l,xl,pb);
