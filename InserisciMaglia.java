...
public class InserisciMaglia extends java.awt.Dialog {
    ...
    /**
     * Creates new form InserisciMaglia
     */
    public InserisciMaglia(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    public static void main(String args[]) {
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                InserisciMaglia dialog = new InserisciMaglia(new java.awt.Frame(), true);
